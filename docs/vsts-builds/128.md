## Build dev.templates.tests.full_20180718.3
- **Build result:** `failed`
- **Build queued:** 7/18/2018 10:15:46 AM
- **Build duration:** 19.83 minutes
### Details
Build [dev.templates.tests.full_20180718.3](https://winappstudio.visualstudio.com/web/build.aspx?pcguid=a4ef43be-68ce-4195-a619-079b4d9834c2&builduri=vstfs%3a%2f%2f%2fBuild%2fBuild%2f26029) failed
...
Find detailed information in the [build log files](https://uwpctdiags.blob.core.windows.net/buildlogs/dev.templates.tests.full_20180718.3_logs.zip)
