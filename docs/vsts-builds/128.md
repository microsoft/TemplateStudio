## Build dev.templates.tests.full_20180719.1
- **Build result:** `failed`
- **Build queued:** 7/19/2018 5:00:01 AM
- **Build duration:** 20.16 minutes
### Details
Build [dev.templates.tests.full_20180719.1](https://winappstudio.visualstudio.com/web/build.aspx?pcguid=a4ef43be-68ce-4195-a619-079b4d9834c2&builduri=vstfs%3a%2f%2f%2fBuild%2fBuild%2f26031) failed
...
Find detailed information in the [build log files](https://uwpctdiags.blob.core.windows.net/buildlogs/dev.templates.tests.full_20180719.1_logs.zip)
