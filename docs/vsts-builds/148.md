## Build v3.0.templates.tests.full_20180917.3
- **Build result:** `failed`
- **Build queued:** 9/17/2018 3:06:01 PM
- **Build duration:** 22.16 minutes
### Details
Build [v3.0.templates.tests.full_20180917.3](https://winappstudio.visualstudio.com/web/build.aspx?pcguid=a4ef43be-68ce-4195-a619-079b4d9834c2&builduri=vstfs%3a%2f%2f%2fBuild%2fBuild%2f26270) failed
...
Find detailed information in the [build log files](https://uwpctdiags.blob.core.windows.net/buildlogs/v3.0.templates.tests.full_20180917.3_logs.zip)
