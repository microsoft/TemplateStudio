## Build v3.0.templates.tests.full_20180917.1
- **Build result:** `failed`
- **Build queued:** 9/17/2018 9:53:52 AM
- **Build duration:** 27.98 minutes
### Details
Build [v3.0.templates.tests.full_20180917.1](https://winappstudio.visualstudio.com/web/build.aspx?pcguid=a4ef43be-68ce-4195-a619-079b4d9834c2&builduri=vstfs%3a%2f%2f%2fBuild%2fBuild%2f26265) failed
...
Find detailed information in the [build log files](https://uwpctdiags.blob.core.windows.net/buildlogs/v3.0.templates.tests.full_20180917.1_logs.zip)
