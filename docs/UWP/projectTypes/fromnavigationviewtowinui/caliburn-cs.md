...
If you have an UWP project created with *TS* with project type **NavigationPane** and framework **CaliburnMicro** please follow these steps to update from NavigationView to Windows UI NavigationView:
