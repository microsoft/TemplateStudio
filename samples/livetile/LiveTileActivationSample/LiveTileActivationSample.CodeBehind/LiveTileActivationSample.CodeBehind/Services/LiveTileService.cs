...
using LiveTileActivationSample.CodeBehind.Activation;
using LiveTileActivationSample.CodeBehind.Helpers;
using LiveTileActivationSample.CodeBehind.Views;
using Windows.ApplicationModel.Activation;
using Windows.Storage;
using Windows.UI.Notifications;
using Windows.UI.StartScreen;

namespace LiveTileActivationSample.CodeBehind.Services
{
