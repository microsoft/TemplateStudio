...
namespace TasksApp.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<MyTasksPage>("Shell_MyTasks".GetLocalized(), Symbol.Bullets));
            _primaryItems.Add(ShellNavigationItem.FromType<NewTaskPage>("Shell_NewTask".GetLocalized(), Symbol.Add));
