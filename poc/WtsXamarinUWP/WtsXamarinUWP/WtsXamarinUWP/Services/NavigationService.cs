...
namespace WtsXamarinUWP.Mobile.Services
{
    public class NavigationService
    {
        private NavigationPage NavPage => (Application.Current.MainPage as Views.Navigation.MasterDetailPage).Detail as NavigationPage;
