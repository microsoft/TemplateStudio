...
namespace MultiViewPoC.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<CompaniesPage>("Shell_Companies".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<ImagesPage>("Shell_Images".GetLocalized(), Symbol.Document));
