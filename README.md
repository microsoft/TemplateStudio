...
* Issue ([#2632](https://github.com/Microsoft/WindowsTemplateStudio/issues/2632)): When using Background Task with Prism the Unity container gets recreated resulting in incorrect dependency resolving. We're removing this line of code to make this work correctly for version 2.5. Meanwhile you can find the manual fix in the tracking issue.
