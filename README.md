...
* Issue ([#1629](https://github.com/Microsoft/WindowsTemplateStudio/issues/1629)): We have detected that the Master-Detail view has an issue if you set the background to Transparent in the MastertDetailControl. We are actively working with the UWPTookit team to get this solved as soon as possible.
