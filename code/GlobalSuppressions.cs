...
[assembly: SuppressMessage("Usage", "VSTHRD101:Avoid unsupported async delegates", Justification = "Event handlers needs async void", Scope = "member", Target = "~M:Microsoft.Templates.VsEmulator.Main.MainView.#ctor")]
...
[assembly: SuppressMessage("Globalization", "CA1303:Do not pass literals as localized parameters", Justification = "Allowing here as this is a helper tool without localization", Scope = "type", Target = "~T:Localization.LocalizationTool")]
[assembly: SuppressMessage("Globalization", "CA1303:Do not pass literals as localized parameters", Justification = "Allowing here as this is a helper tool without localization", Scope = "member", Target = "~M:Microsoft.Templates.VsEmulator.LoadProject.LoadProjectViewModel.ShowFileDialog")]

[assembly: SuppressMessage("Interoperability", "CA1401:P/Invokes should not be visible", Justification = "Allowing here as this is a helper tool", Scope = "member", Target = "~M:Microsoft.Templates.VsEmulator.NativeMethods.AllocConsole~System.Boolean")]
[assembly: SuppressMessage("Interoperability", "CA1401:P/Invokes should not be visible", Justification = "Allowing here as this is a helper tool", Scope = "member", Target = "~M:Microsoft.Templates.VsEmulator.NativeMethods.AttachConsole(System.Int32)~System.Boolean")]
[assembly: SuppressMessage("Interoperability", "CA1401:P/Invokes should not be visible", Justification = "Allowing here as this is a helper tool", Scope = "member", Target = "~M:Microsoft.Templates.VsEmulator.NativeMethods.FreeConsole~System.Int32")]
