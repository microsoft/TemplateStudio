...
namespace Microsoft.Templates.Core.Locations
{
    public class LocalTemplatesSource : TemplatesSource
    {
        ...
        public LocalTemplatesSource(string installedPackagePath, string templatesVersion = null, string id = null, string platform = null)
            : this(installedPackagePath, GenContext.GetWizardVersionFromAssembly().ToString(), id)
        {
            Platform = platform;
        }
        ...
        {
            // This throws because nothing should be using the directly 😀
