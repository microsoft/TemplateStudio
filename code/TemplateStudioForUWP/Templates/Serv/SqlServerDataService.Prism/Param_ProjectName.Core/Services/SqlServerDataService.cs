...
namespace Param_RootNamespace.Core.Services
{
    ...
    public static class SqlServerDataService
    {
        ...
        private static string GetConnectionString()
        {
            ...
            // Learn more about specifying the connection string in a config file at https://docs.microsoft.com/dotnet/api/system.configuration.configurationmanager?view=netframework-4.8.1
