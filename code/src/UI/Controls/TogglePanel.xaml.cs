...
namespace Microsoft.Templates.UI.Controls
{
    public partial class TogglePanel : UserControl
    {
        ...
        private void OnMainGridGotFocus(object sender, RoutedEventArgs e) => MainViewModel.Current.SavedTemplateGotFocus(TogglePanelContent as SavedTemplateViewModel);
        ...
        private void OnMainViewKeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                if (MainViewModel.Current.SavedTemplateSetDrag(TogglePanelContent as SavedTemplateViewModel))
                {
                    dragAndDropShadowBorder.Opacity = 1;
                }
                else
                {
                    MainViewModel.Current.SavedTemplateSetDrop(TogglePanelContent as SavedTemplateViewModel);
                }
            }
            if (e.Key == Key.Escape)
            {
