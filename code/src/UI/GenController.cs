    ...
    public class GenController
    {
        ...
        public static async Task UnsafeGenerateAsync(UserSelection userSelection)
        {
            ...
            foreach (var genInfo in genItems)
            {
                ...
                AppHealth.Current.Info.TrackAsync(string.Format(StringRes.GenControllerUnsafeGenerateAsyncMessage, genInfo.Template.Name, GenContext.Current.OutputPath)).FireAndForget();
