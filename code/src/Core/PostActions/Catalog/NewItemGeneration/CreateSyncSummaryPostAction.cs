    ...
    public class CreateSyncSummaryPostAction : PostAction<TempGenerationResult>
    {
        ...
        public override void Execute()
        {
            ...
            if (_config.ConflictingFiles.Any())
            {
                ...
                sb.AppendLine("These files already existed in your project and but were also generated by new item generation. Please make sure everything is in the right place.");
                sb.AppendLine();
        ...
        {
            return $"* Temp: [{fileName}]({fileName}), Project File: [{fileName}]({Uri.EscapeUriString(filePath)})";
        }
    }
}
