...
using Microsoft.Templates.Core.PostActions.Catalog.NewItemGeneration;
using Microsoft.Templates.Core.PostActions.Catalog.NewItemGeneration.T4;

namespace Microsoft.Templates.Core.PostActions.Catalog
{
    public class CreateTTSummaryPostAction : PostAction<TempGenerationResult>
    {
        public CreateTTSummaryPostAction(TempGenerationResult config) : base(config)
        {
        }
        ...
        public override void Execute()
        {
            ...
            if (_config.SyncGeneration)
            {
                ...
                template.OutputPath = GenContext.Current.OutputPath;
        ...
        private static SyncSummaryTemplate GetTemplate()
        {
            return new MyLanguageTT();
        }
        ...
        private string GetFileName()
        {
            if (_config.SyncGeneration)
            {
                return Path.Combine(GenContext.Current.OutputPath, "testsummaryTT.md");
            }
            else
            {
