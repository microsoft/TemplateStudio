...
namespace Microsoft.Templates.Core.PostActions.Catalog
{
    ...
    //        "args": {
    //            "fileIndex" : "0",
    //            "otherProjectPath": "Param_ProjectName\\Param_ProjectName.csproj"
    //        },
    ...
    public class MakeOtherProjectReferenceThisOnePostAction : TemplateDefinedPostAction
    {
        ...
        public MakeOtherProjectReferenceThisOnePostAction(string relatedTemplate, IPostAction templatePostAction, IReadOnlyList<ICreationPath> primaryOutputs, Dictionary<string, string> parameters)
        ...
        internal override void ExecuteInternal()
        {
            ...
            var projectPath = Path.Combine(GenContext.Current.OutputPath, parameterReplacements.ReplaceInPath(Args["otherProjectPath"]));
