...
{
    public abstract class BaseFileEncodingTests
    {
        public abstract void EnsureAllTemplateFilesAreEncodedCorrectly();

        public void EnsureEncodingsInternal(string templatesRoot)
        {
