...
namespace Microsoft.UI.Test.ProjectTests
{
    [Collection("UI")]
    [Trait("Group", "Minimum")]
    public class NewWinUICppProjectTest : IClassFixture<WinUICppPlatformTemplatesFixture>
    {
        private const string DefaultProjectType = "Blank";
        private const string DefaultFramework = "None";

        public NewWinUICppProjectTest(WinUICppPlatformTemplatesFixture fixture)
        {
            fixture.InitializeFixture(Platforms.WinUI, ProgrammingLanguages.Cpp);
        }
