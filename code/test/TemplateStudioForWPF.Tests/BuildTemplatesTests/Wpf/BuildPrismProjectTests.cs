...
namespace Microsoft.Templates.Test.WPF.Build
{
    ...
    {
        public BuildPrismProjectTests(WpfBuildTemplatesTestFixture fixture)
        ...
        [Theory]
        [MemberData(nameof(WpfBaseGenAndBuildTests.GetPageAndFeatureTemplatesForBuild), Frameworks.Prism, ProgrammingLanguages.CSharp, Platforms.Wpf, "ts.WPF.Feat.MSIXPackaging")]
