...
namespace Microsoft.Templates.Test.WPF.Build
{
    ...
    public class BuildMVVMToolkitProjectTests : WpfBaseGenAndBuildTests
    {
        ...
        [Theory]
        [MemberData(nameof(WpfBaseGenAndBuildTests.GetPageAndFeatureTemplatesForBuild), Frameworks.MVVMToolkit, ProgrammingLanguages.CSharp, Platforms.Wpf, "ts.WPF.Feat.MSIXPackaging")]
