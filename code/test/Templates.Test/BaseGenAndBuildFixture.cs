...
namespace Microsoft.Templates.Test
{
    public abstract class BaseGenAndBuildFixture
    {
        ...
        public void AddItem(UserSelection userSelection, string itemName, ITemplateInfo template)
        {
            ...
            var dependencies = GenContext.ToolBox.Repo.GetAllDependencies(template, userSelection.Platform, userSelection.ProjectType, userSelection.FrontEndFramework, userSelection.BackEndFramework);
