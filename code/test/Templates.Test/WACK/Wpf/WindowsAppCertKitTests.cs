...
namespace Microsoft.Templates.Test.Wack.Wpf
{
    ...
    public class WindowsAppCertKitTests : BaseGenAndBuildTests
    {
        ...
        [Theory]
        [MemberData(nameof(GetProjectTemplatesForBuild), "MVVMBasic", ProgrammingLanguages.CSharp, Platforms.Wpf)]
        public async Task WackTests_MvvmBasic_Excluded_WPFAsync(string projectType, string framework, string platform, string language)
        {
        ...
        [Theory]
        [MemberData(nameof(GetProjectTemplatesForBuild), "MVVMLight", ProgrammingLanguages.CSharp, Platforms.Wpf)]
        public async Task WackTests_MVVMLight_Excluded_WPFAsync(string projectType, string framework, string platform, string language)
        {
            await RunWackOnProjectWithExcludedPagesAndFeaturesAsync(projectType, framework, platform, language);
        }
        ...
        [Theory]
        [MemberData(nameof(GetProjectTemplatesForBuild), "Prism", ProgrammingLanguages.CSharp, Platforms.Wpf)]
        public async Task WackTests_Prism_Excluded_WPFAsync(string projectType, string framework, string platform, string language)
        {
            await RunWackOnProjectWithExcludedPagesAndFeaturesAsync(projectType, framework, platform, language);
        }
