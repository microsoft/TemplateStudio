...
namespace Microsoft.Templates.Test.BuildWithLegacy
{
    public sealed class BuildRightClickWithLegacyVBFixture : BaseGenAndBuildFixture, IDisposable
    {
        ...
        public static IEnumerable<object[]> GetProjectTemplates()
        {
            ...
            InitializeTemplates(new LegacyTemplatesSourceV2(ProgrammingLanguages.VisualBasic), ProgrammingLanguages.VisualBasic);
            ...
            foreach (var projectType in projectTypes)
            {
                ...
                {
                    result.Add(new object[] { projectType, framework, Platforms.Uwp, ProgrammingLanguages.VisualBasic });
                }
            }            
 ...
 Justification = "Required for unit testing.")]
        ...
        public override void InitializeFixture(IContextProvider contextProvider, string language = "")
        {
            ...
            Configuration.Current.CdnUrl = "https://wtsrepository.blob.core.windows.net/pro/";
            InitializeTemplates(Source, ProgrammingLanguages.VisualBasic);
        }
    }
}
