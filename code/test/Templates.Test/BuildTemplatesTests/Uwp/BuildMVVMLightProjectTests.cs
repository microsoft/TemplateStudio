...
namespace Microsoft.Templates.Test.Build.Uwp
{
    ...
    public class BuildMVVMLightProjectTests : BaseGenAndBuildTests
    {
        ...
        public async Task Build_MVVMLight_CS_OneByOneItems_UwpAsync(string itemName, string projectType, string framework, string platform, string itemId, string language)
        {
            var context = new UserSelectionContext(language, platform)
            {
                ProjectType = projectType,
        ...
        [Trait("ExecutionSet", "_OneByOne")]
        [Trait("Type", "BuildOneByOneMVVMLight")]
        public async Task Build_MVVMLight_VB_OneByOneItems_UwpAsync(string itemName, string projectType, string framework, string platform, string itemId, string language)
        {
            var context = new UserSelectionContext(language, platform)
            {
                ProjectType = projectType,
