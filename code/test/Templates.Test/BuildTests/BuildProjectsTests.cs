...
namespace Microsoft.Templates.Test
{
    ...
    {
        public BuildProjectTests(BuildFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        //    var projectPath = await AssertGenerateProjectAsync("build", selector, projectName, projectType, framework, language, GenerationFixture.GetDefaultName, false);
        ...
        //    var projectPath = await AssertGenerateProjectAsync("build", selector, projectName, projectType, framework, language, GenerationFixture.GetRandomName, false);
        ...
        //    var projectPath = await AssertGenerateRightClickAsync("build", projectName, projectType, framework, language, true, false);
        ...
        //    var projectPath = await AssertGenerateRightClickAsync("build", projectName, projectType, framework, language, false, false);
        ...
        //{
        //    var result = await AssertGenerationOneByOneAsync("build", itemName, projectType, framework, itemId, language, false);
