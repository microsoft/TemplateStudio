Esse recurso adiciona um novo projeto à solução. Este projeto permite a criação de pacotes MSIX que contêm aplicativos Windows para sideload ou distribuição via Microsoft Store.
