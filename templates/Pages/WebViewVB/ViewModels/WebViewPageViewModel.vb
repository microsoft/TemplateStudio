        ...
        Public ReadOnly Property BrowserBackCommand() As ICommand
            Get
                If _browserBackCommand Is Nothing Then
                    _browserBackCommand = New RelayCommand(Function() _webView?.GoBack(),
                        Function() _webView?.CanGoBack.GetValueOrDefault)
                End If
        ...
        Public ReadOnly Property BrowserForwardCommand() As ICommand
            Get
                If _browserForwardCommand Is Nothing Then
                    _browserForwardCommand = New RelayCommand(Function() _webView?.GoForward(),
                        Function() _webView?.CanGoForward.GetValueOrDefault)
                End If
        ...
        Public ReadOnly Property RefreshCommand() As ICommand
            Get
                If _refreshCommand Is Nothing Then
                    _refreshCommand = New RelayCommand(Function() _webView?.Refresh())
                End If
        ...
        Public ReadOnly Property OpenInBrowserCommand() As ICommand
            Get
                If _openInBrowserCommand Is Nothing Then
                    _openInBrowserCommand = New RelayCommand(Async Function() Await Windows.System.Launcher.LaunchUriAsync(Source))
                End If
