...
namespace Param_RootNamespace.Views
{
    public partial class wts.ItemNamePage : Page, INotifyPropertyChanged, INavigationAware
    {
        ...
        public wts.ItemNamePage(INavigationService navigationService, ISampleDataService sampleDataService)
        {
        ...
        private void SelectItem(RoutedEventArgs args)
        {
            ...
            {
                _navigationService.NavigateTo(typeof(wts.ItemNameDetailPage), order.OrderID);
            }
        }
    }
}
