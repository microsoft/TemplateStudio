...
{
    public class BasicMapPageViewModel : ViewModelBase
    {
        ...
        private void AddMapIcon(Geopoint position, string title)
        {
            ...
            mapIcon.Title = title;
            mapIcon.Image = RandomAccessStreamReference.CreateFromUri(new Uri("ms-appx:///BasicMapPage/map.png"));
            mapIcon.ZIndex = 0;
