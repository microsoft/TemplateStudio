適切なタイミングで適切なメッセージを使用して顧客に働きかけることが、アプリ開発者としての成功の鍵となります。Windows デベロッパー センターは、データドリブンの顧客エンゲージメント プラットフォームを提供します。このプラットフォームを使用して、すべての顧客に通知を送信したり、顧客セグメントで定義した条件を満たす Windows 10 顧客のみに通知を送信することができます。
