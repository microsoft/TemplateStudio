성공적인 앱 개발자는 적시에 올바른 메시지로 고객의 참여를 유도해야 합니다. Windows 개발자 센터에서 제공하는 데이터 기반의 고객 참여 플랫폼을 사용하면 모든 고객에게 알림을 보내거나 고객층에서 정의한 기준을 충족하는 일부 Windows 10 고객에게만 알림을 전송할 수 있습니다.
