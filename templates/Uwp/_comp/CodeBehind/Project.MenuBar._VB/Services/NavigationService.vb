...
Namespace Services
    Module NavigationService
        ...
        Function Navigate(pageType As Type, Optional parameter As Object = Nothing, Optional infoOverride As NavigationTransitionInfo = Nothing, Optional clearNavigation As Boolean = False) As Boolean
        ...
        Function Navigate(Of T As Page)(Optional parameter As Object = Nothing, Optional infoOverride As NavigationTransitionInfo = Nothing, Optional clearNavigation As Boolean = False) As Boolean
            Return Navigate(GetType(T), parameter, infoOverride, clearNavigation)
        End Function
